...
//     if(type==="tags"){
//       selectedTags.length===uniqueAvailableTags.length?setSelectedTags([]):setSelectedTags(uniqueAvailableTags)
//     }else{
//       selectedCustomTags.length===availableCustomTags.length?setSelectedCustomTags([]):setSelectedCustomTags(availableCustomTags)
//     }
//   }
//   const toggleTag = (tag) => {
...
//           }else if(server.type==="S-7"){
//             console.log("Siemens api hit")
...
//                         />
//                         <label className="text-gray-700 font-medium">Select all the tags </label>
//         </div>
...
//                           className="h-4 w-4 mr-3  text-blue-600"
//                         />
//                         <label className="text-gray-700 font-medium">Select all the custom tags </label>
//         </div>
//         <div className="mb-3 flex items-center space-x-2">
//           <label className="text-gray-700 font-medium"> | Filter by Protocol:</label>
//           <select
...
//                   }`}
//                 >
//                   <h3 className="font-medium">{db.type.replace("_"," ")}</h3>
...
// };
import { useState, useEffect } from "react";
import { Server, Tag, Database, Settings, ChevronRight } from "lucide-react";
import axios from "axios";
import { useNotify } from "../../context/ConfirmContext";
    ...
    try {
      ...
      await Promise.allSettled(
        selectedServers.map((server) => {
          let apiDetails;
          if (server.type === "OPC UA") apiDetails = SERVER_REGISTRY.OPCUA;
