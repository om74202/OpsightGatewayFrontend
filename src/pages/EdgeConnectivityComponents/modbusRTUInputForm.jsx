...
export const ModbusRTUConfig = () => {
  ...
  const getServerList = async () => {
    ...
    try {
      ...
      const list = response.data.servers.filter((d) => d.type === "RTU");
      setServerList(list);
    } catch (e) {
      console.log(e);
    }
      ...
      <div className="max-w-8xl mx-auto">
        ...
        {/* <div className="mb-2">
          ...
          <p className="text-gray-600 mt-2">
            Configure Modbus RTU (RS485) serial connection parameters.
          </p>
        </div> */}
        ...
        <div className="bg-white rounded-lg shadow-sm border border-gray-200">
          <div className="border-b border-gray-200 p-6">
            <h2 className="text-lg font-semibold text-gray-800">Modbus RTU Connections</h2>
            <p className="text-sm text-gray-600 mt-1">
              View all configured Modbus RTU connections. Total entries: {serverList.length}
            </p>
          </div>
                  ...
                  <tr key={server.serverId} className="border-b border-gray-100 hover:bg-gray-50 transition-colors">
                    {editingId === server.serverId ? (
                      <>
                        ...
                        <td className="py-3 px-6">
                          <input
                            ...
                            onChange={(e) => handleEdit("serverBaudrate", e.target.value)}
                            className="w-full px-2 py-1 text-sm border border-gray-300 rounded focus:outline-none focus:ring-2 focus:ring-blue-500"
                          />
                        </td>
                        <td className="py-3 px-6">
                          <input
                            ...
                            onChange={(e) => handleEdit("serverParity", e.target.value)}
                            className="w-full px-2 py-1 text-sm border border-gray-300 rounded focus:outline-none focus:ring-2 focus:ring-blue-500"
                          />
                        </td>
                      ...
                      <>
                        ...
                        <td className="py-3 px-6 text-sm text-gray-600">{server.serverPort}</td>
                        <td className="py-3 px-6 text-sm text-gray-600">{server.serverBaudrate}</td>
                        <td className="py-3 px-6 text-sm text-gray-600">{server.serverParity}</td>
                        {/* <td className="py-3 px-6 text-sm text-gray-600">
                          {new Date(server.createdAt || "2025-09-02").toLocaleDateString()}
                        </td> */}
                        <td className="py-3 px-6">
